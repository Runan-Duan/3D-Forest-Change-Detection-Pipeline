...
```{r}
dtm_2024 <- rasterize_terrain(ground_2024, 1, knnidw())
dtm_2025 <- rasterize_terrain(ground_2025, 1, knnidw())
```
...
```{r}
norm_trees_2024 <- normalize_height(trees_2024, tin(), dtm = dtm_2024)
norm_trees_2025 <- normalize_height(trees_2025, tin(), dtm = dtm_2025)
```
...
plot(chm_2024, col = col)
plot(chm_2025, col = col)
```
...
```{r}
ttops <- locate_trees(tree_denoise, lmf(ws = 5))
